...
class PetAdoptionTablePlugin {
  function __construct() {
    ...
    add_action('admin_post_createpet', array($this, 'createPet')); //send a POST request to create a new pet (see template-pets.php POST form)
    add_action('admin_post_nopriv_createpet', array($this, 'createPet'));
    add_action('admin_post_deletepet', array($this, 'deletePet')); //send a request to delete pet (see template-pets.php POST form)
